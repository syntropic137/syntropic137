...
async def run_phase1_workflow(_live: bool = False) -> dict:
    ...
    test_content = f'''"""Auto-generated test file by Syn137.
...
def test_hello_world():
    """Simple test to verify Syn137 workflow."""
    assert 1 + 1 == 2
...
class TestSyn137Integration:
    """Integration tests for Syn137."""
...
'''
    ...
    pr_body = f"""## 🤖 Auto-generated by Syn137

This PR was created by the Syn137 E2E integration test.
...
"""
    ...
    pr_result = await github_client.api_post(
        ...
        json={
            "title": f"[Syn137 Test] {execution_id}",
            "body": pr_body,
            "head": branch_name,
            "base": default_branch,
        },
...
async def main() -> int:
    ...
    print_header("🧪 Syn137 E2E Integration Test: Agentic Workflow")
