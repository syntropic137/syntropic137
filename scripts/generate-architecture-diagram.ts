#!/usr/bin/env ts-node
/**
 * Generate Syn137 architecture diagram with configuration
 * 
 * Usage:
...
async function main() {
  console.log('🏗️  Generating Syn137 Architecture Diagram...\n');
  ...
  const config = {
    applications: ['Syn137 CLI', 'Dashboard API', 'Dashboard UI'],
    infrastructure: [
  ...
  console.log(`\n💡 Embed in README.md:`);
  console.log(`   ![Syn137 Architecture](./docs/architecture/vsa-overview.svg)\n`);
}
