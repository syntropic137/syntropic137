/**
 * Shared SVG icon components for ui-feedback
 */

// --- FeedbackWidget icons ---

export function FeedbackIcon({ size = 24 }: { size?: number }) {
  return (
...
export function PinIcon({ size = 24 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="var(--feedback-primary)" stroke="white" strokeWidth="1.5">
...
export function PinSelectIcon({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
// --- ScreenshotUploader icons ---

export function CropIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M6 2v4" />
      <path d="M6 14v4" />
