...
| **Per-Tool Tokens** | ❌ | ❌ | ❌ | 📋 [Issue #30](https://github.com/syntropic137/syntropic137/issues/30) |
...
- [Agentic Events Reference](../../lib/agentic-workspace/lib/python/agentic_events/README.md) - Event types
