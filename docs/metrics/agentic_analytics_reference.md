...
1. **DORA Metrics** - Industry-standard software delivery performance
2. **Agent/Semantic Metrics** - AI agent efficiency and output quality
...
WITH token_totals AS (
  ...
  FROM events
  WHERE event_type = 'agent_session.tokens_used'
