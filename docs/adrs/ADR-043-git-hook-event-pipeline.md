...
| `lib/agentic-workspace/lib/python/agentic_isolation/.../providers/docker.py` | agentic_isolation library (moved from agentic-primitives, 2026-09, see #1417) |
...
- [ADR-022](../../lib/agentic-primitives/docs/adrs/022-git-hook-observability.md) - original git hook design in agentic-primitives (pre-container, file-based; historical, no agentic-workspace equivalent)
- [ADR-029](../../lib/agentic-primitives/docs/adrs/029-simplified-event-system.md) - JSONL event system (`agentic_events`) (historical, no agentic-workspace equivalent)
- [ADR-015](./ADR-015-agent-observability.md) — agent session observability
- [ADR-033](../../lib/agentic-workspace/docs/adrs/033-plugin-native-workspace-images.md) - plugin architecture for workspace images (moved to agentic-workspace, 2026-09)
...
lib/agentic-workspace/workspace/capabilities/git/post-commit
    Emits git_commit to sys.stderr via EventEmitter

lib/agentic-workspace/workspace/capabilities/git/pre-push
    Emits git_push to sys.stderr via EventEmitter

lib/agentic-workspace/workspace/entrypoint.sh
