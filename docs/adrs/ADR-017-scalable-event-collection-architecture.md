...
**Accepted** - 2025-12-09 | **Storage layer superseded by [ADR-026](ADR-026-timescaledb-observability-storage.md)** — Collector now writes directly to TimescaleDB via `AgentEventStore`, not to the gRPC event store.
