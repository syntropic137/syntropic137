...
from aef_domain.contexts.github.slices.list_triggers.projection import (
...
if TYPE_CHECKING:
    ...
    from aef_domain.contexts.github.domain.read_models.trigger_rule import TriggerRule
