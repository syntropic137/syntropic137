...
from aef_perf.reporters import ConsoleReporter, JSONReporter
...
def single(
    ...
    """
    from aef_perf.benchmarks import SingleBenchmark
...
def parallel(
    ...
    """
    from aef_perf.benchmarks import ParallelBenchmark
...
def throughput(
    ...
    """
    from aef_perf.benchmarks import ThroughputBenchmark
...
def compare(
    ...
    """
    from aef_perf.benchmarks import BackendComparison
