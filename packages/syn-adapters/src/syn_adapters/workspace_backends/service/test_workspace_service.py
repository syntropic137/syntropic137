...
Run: pytest packages/syn-adapters/src/syn_adapters/workspace_backends/service/test_workspace_service.py -v
"""
...
from syn_adapters.workspace_backends.service import WorkspaceBackend
...
class TestWorkspaceServiceDocker:
    ...
    async def test_create_docker_service(self) -> None:
        ...
        with patch("syn_tokens.vending.get_token_vending_service") as mock_tvs:
...
class TestWorkspaceServiceConfig:
    ...
    def test_default_config(self) -> None:
        ...
        from syn_adapters.workspace_backends.service import WorkspaceServiceConfig
