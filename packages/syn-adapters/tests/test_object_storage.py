...
class TestStorageSettings:
    ...
    def test_minio_settings_validation(self) -> None:
        ...
        try:
            ...
            assert "MinIO storage requires" in str(e) or "SYN_STORAGE_MINIO" in str(e)
...
class TestMinioStorage:
    ...
    async def test_upload_error(self, storage: MinioStorage) -> None:
        ...
        from syn_adapters.object_storage import UploadError
...
class TestStorageFactory:
    ...
    async def test_get_storage_minio(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setenv("SYN_STORAGE_PROVIDER", "minio")
        monkeypatch.setenv("SYN_STORAGE_MINIO_ENDPOINT", "localhost:9000")
        monkeypatch.setenv("SYN_STORAGE_MINIO_ACCESS_KEY", "minioadmin")
        monkeypatch.setenv("SYN_STORAGE_MINIO_SECRET_KEY", "minioadmin")
        monkeypatch.setenv("SYN_STORAGE_MINIO_SECURE", "false")
        reset_storage()
...
class TestArtifactBundleStorage:
    ...
    async def test_bundle_save_and_load(self, storage: LocalStorage) -> None:
        ...
        from syn_adapters.artifacts.bundle import ArtifactBundle, ArtifactType
