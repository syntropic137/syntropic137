...
class TestSchemaConsistency:
    ...
    def migrations_dir(self) -> Path:
        ...
        return Path(__file__).parent.parent.parent / "src/syn_adapters/projection_stores/migrations"

    @pytest.fixture
    def init_db_path(self) -> Path:
        """Path to Docker init-db script."""
        # Navigate up to repo root from:
        # packages/syn-adapters/tests/events/test_schema_consistency.py
        # -> packages/syn-adapters/tests/events
