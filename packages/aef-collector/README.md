...
Scalable event collection for AI agent observability in the Agentic Engineering Framework.

## Overview

The `aef-collector` package provides:
...
uv run aef-collector serve --port 8080 --eventstore-host localhost --eventstore-port 50051
```
