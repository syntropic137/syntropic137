...
from aef_collector.collector.service import create_app
from aef_collector.collector.store import InMemoryEventStore
...
class TestLocalModeIntegration:
    ...
    async def test_hook_event_to_collector_flow(
        ...
        # Send to collector
        from aef_collector.events.types import EventBatch
    ...
    async def test_concurrent_batches(self) -> None:
        ...
        with TestClient(app) as client:
            ...
            for agent_id in range(10):
                from aef_collector.events.types import CollectedEvent, EventBatch, EventType
