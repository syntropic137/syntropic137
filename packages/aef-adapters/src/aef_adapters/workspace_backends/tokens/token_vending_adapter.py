...
Wraps the aef-tokens TokenVendingService to implement TokenVendingPort.
...
class TokenVendingServiceAdapter:
    """Adapter wrapping aef-tokens TokenVendingService.
    ...
    def __init__(self, service: TokenVendingService) -> None:
        ...
        Args:
            service: The underlying TokenVendingService from aef-tokens
        """
    ...
    async def vend_token(
        ...
        *,
        ...
        """
        from aef_tokens.models import TokenScope
        from aef_tokens.models import TokenType as AefTokenType

        # Map domain TokenType to aef-tokens TokenType
        aef_token_type = AefTokenType(token_type.value)
