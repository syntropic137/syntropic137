...
if TYPE_CHECKING:
    from aef_adapters.conversations.protocol import SessionContext
...
class MinioConversationStorage:
    ...
    Usage:
        storage = MinioConversationStorage(
            ...
            db_url="postgresql://aef:aef@localhost:5432/aef",
        )
...
async def create_conversation_storage(
    ...
    - AEF_STORAGE_MINIO_ENDPOINT
    - AEF_STORAGE_MINIO_ACCESS_KEY
    - AEF_STORAGE_MINIO_SECRET_KEY
    - AEF_DATABASE_URL
    ...
    storage = MinioConversationStorage(
        endpoint=endpoint or os.environ.get("AEF_STORAGE_MINIO_ENDPOINT", "localhost:9000"),
        access_key=access_key or os.environ.get("AEF_STORAGE_MINIO_ACCESS_KEY", "minioadmin"),
