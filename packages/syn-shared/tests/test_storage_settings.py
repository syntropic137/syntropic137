...
class TestStorageSettings:
    ...
    def test_supabase_provider_requires_credentials(self) -> None:
        ...
        assert "SYN_STORAGE_SUPABASE_URL" in error_msg
        assert "SYN_STORAGE_SUPABASE_KEY" in error_msg
    ...
    def test_supabase_provider_requires_url(self) -> None:
        ...
        assert "SYN_STORAGE_SUPABASE_URL" in str(exc_info.value)
    ...
    def test_supabase_provider_requires_key(self) -> None:
        ...
        assert "SYN_STORAGE_SUPABASE_KEY" in str(exc_info.value)
    ...
    def test_supabase_from_environment(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setenv("SYN_STORAGE_PROVIDER", "supabase")
        monkeypatch.setenv("SYN_STORAGE_SUPABASE_URL", "https://test.supabase.co")
        monkeypatch.setenv("SYN_STORAGE_SUPABASE_KEY", "test-key")
        monkeypatch.setenv("SYN_STORAGE_BUCKET_NAME", "test-bucket")
