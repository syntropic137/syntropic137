...
async def pause(
    ...
    Args:
        ...
        auth: Optional authentication context.
    """
    from aef_adapters.control.commands import PauseExecution
...
async def resume(
    ...
    Args:
        ...
        auth: Optional authentication context.
    """
    from aef_adapters.control.commands import ResumeExecution
...
async def cancel(
    ...
    Args:
        ...
        auth: Optional authentication context.
    """
    from aef_adapters.control.commands import CancelExecution
...
async def inject(
    ...
    Args:
        ...
        auth: Optional authentication context.
    """
    from aef_adapters.control.commands import InjectContext
