...
AEF_OBSERVABILITY_DB_URL=           # Observability database URL
...
# Workspace
AEF_WORKSPACE_CONTAINER_DIR=        # Container workspace directory
AEF_WORKSPACE_HOST_DIR=             # Host workspace directory
...
async def get_config(
    ...
    database = {
        ...
        "aef_observability_db_url": _mask(settings.aef_observability_db_url)
...
async def validate_config(
    ...
    try:
        from aef_adapters.agents import get_available_agents
