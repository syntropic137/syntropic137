"""Tests for aef_api.v1.sessions — start, list, complete cycle.
...
async def test_list_sessions_empty():
    ...
    from aef_api.v1.sessions import list_sessions
...
async def test_start_session():
    """Start a new session."""
    from aef_api.v1.sessions import start_session
...
async def test_start_and_list_sessions():
    ...
    """
    from aef_api.v1.sessions import list_sessions, start_session
...
async def test_complete_session():
    ...
    from aef_api.v1.sessions import complete_session, start_session
