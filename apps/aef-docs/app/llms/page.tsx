...
import { Bot, FileText, Copy, Check, ExternalLink, Download, BookOpen, Cpu } from 'lucide-react';
...
const SYSTEM_PROMPT = `You are an expert on Syntropic137, an agentic engineering platform for orchestrating AI coding agents with event-sourced workflows.
...
- **CLI**: The \`aef\` command-line tool for workflow management
