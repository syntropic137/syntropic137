---
title: Self-Hosting
description: Deploy AEF on your own infrastructure — from homelab to Kubernetes
---

## Deployment Architecture

AEF runs as a set of Docker services connected through a shared network:
...
|---------|------|-------------|
| `aef-dashboard` | 8000 | FastAPI backend — REST API, WebSocket, SSE |
...
For **100–1,000 concurrent agents**, run multiple AEF instances behind a load balancer:
