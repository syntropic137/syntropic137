---
title: Overview
description: Agentic Engineering Framework — orchestrate AI agents with event-sourced workflows
---

## What is AEF?

The **Agentic Engineering Framework** (AEF) is an event-sourced platform for orchestrating AI coding agents. It provides workflow execution, real-time observability, workspace isolation, and cost tracking — everything you need to run AI agents in production with confidence.
...
AEF is built on four bounded contexts:
...
- [Getting Started](/docs/guide/getting-started) — Install AEF and run your first workflow
...
- [Self-Hosting](/docs/guide/self-hosting) — Deploy AEF on your own infrastructure
