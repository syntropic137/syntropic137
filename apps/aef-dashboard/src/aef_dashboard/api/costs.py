"""Cost tracking API endpoints — thin wrapper over aef_api."""
...
import aef_api.v1.metrics as met
...
def _session_cost_to_api(c: Any) -> SessionCostResponse:
    """Convert aef_api SessionCostData to dashboard SessionCostResponse."""
...
def _execution_cost_to_api(c: Any) -> ExecutionCostResponse:
    """Convert aef_api ExecutionCostData to dashboard ExecutionCostResponse."""
