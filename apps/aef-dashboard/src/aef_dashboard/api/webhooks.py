"""GitHub webhook endpoints — thin wrapper over aef_api."""
...
import aef_api.v1.github as gh
...
async def github_webhook(
    ...
    Processes installation and other events via aef_api.v1.github.
    """
