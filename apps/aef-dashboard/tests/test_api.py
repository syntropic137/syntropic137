...
async def create_test_workflow(workflow_id: str = "test-wf-1") -> WorkflowAggregate:
    """Create a test workflow and save it."""
...
async def create_test_artifact(
    ...
    """Create a test artifact and save it."""
...
class TestWorkflowEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_workflows_empty(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_workflows_pagination(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_workflow(self, client: TestClient) -> None:
        """Test getting a single workflow."""
        await create_test_workflow("test-wf-1")

        response = client.get("/api/workflows/test-wf-1")
        assert response.status_code == 200
        data = response.json()
    ...
    @pytest.mark.asyncio
    async def test_get_workflow_not_found(self, client: TestClient) -> None:
        """Test getting non-existent workflow."""
        response = client.get("/api/workflows/nonexistent")
        assert response.status_code == 404

    @pytest.mark.asyncio
    async def test_get_workflow_history(self, client: TestClient) -> None:
        ...
        response = client.get("/api/workflows/test-wf-1/history")
        assert response.status_code == 200
        data = response.json()
...
class TestSessionEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_sessions_empty(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_sessions(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_sessions_by_workflow(self, client: TestClient) -> None:
        ...
        response = client.get("/api/sessions?workflow_id=wf-1")
        assert response.status_code == 200
        data = response.json()
        assert len(data) == 1
    ...
    @pytest.mark.asyncio
    async def test_get_session(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_get_session_not_found(self, client: TestClient) -> None:
...
class TestArtifactEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts_empty(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_list_artifacts_by_workflow(self, client: TestClient) -> None:
        ...
        response = client.get("/api/artifacts?workflow_id=wf-1")
        assert response.status_code == 200
        data = response.json()
        assert len(data) == 1
        assert data[0]["workflow_id"] == "wf-1"
    ...
    @pytest.mark.asyncio
    async def test_get_artifact_without_content(self, client: TestClient) -> None:
        """Test getting artifact without content."""
        await create_test_workflow("wf-1")
        await create_test_artifact("art-1", "wf-1", "phase-1")

        response = client.get("/api/artifacts/art-1")
        assert response.status_code == 200
        data = response.json()
    ...
    @pytest.mark.asyncio
    async def test_get_artifact_with_content(self, client: TestClient) -> None:
        """Test getting artifact with content."""
        await create_test_workflow("wf-1")
        await create_test_artifact("art-1", "wf-1", "phase-1")

        response = client.get("/api/artifacts/art-1?include_content=true")
        assert response.status_code == 200
        data = response.json()
        assert data["id"] == "art-1"
    ...
    @pytest.mark.asyncio
    async def test_get_artifact_content_only(self, client: TestClient) -> None:
        """Test getting artifact content only."""
        await create_test_workflow("wf-1")
        await create_test_artifact("art-1", "wf-1", "phase-1")

        response = client.get("/api/artifacts/art-1/content")
        assert response.status_code == 200
        data = response.json()
    ...
    @pytest.mark.asyncio
    async def test_get_artifact_not_found(self, client: TestClient) -> None:
...
class TestMetricsEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_metrics_empty(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_metrics_with_data(self, client: TestClient) -> None:
    ...
    @pytest.mark.asyncio
    async def test_metrics_for_workflow(self, client: TestClient) -> None:
        ...
        response = client.get("/api/metrics?workflow_id=wf-1")
        assert response.status_code == 200
        data = response.json()
        assert data["total_workflows"] == 1
...
class TestEventsEndpoints:
    ...
    def test_get_recent_events_empty(self, client: TestClient) -> None:
    ...
    def test_get_recent_events_filtered(self, client: TestClient) -> None:
        """Test filtering events by workflow."""
        push_event("workflow_started", {"workflow_id": "wf-1"})
        push_event("workflow_started", {"workflow_id": "wf-2"})

        response = client.get("/api/events/recent?workflow_id=wf-1")
        assert response.status_code == 200
        data = response.json()
        assert len(data) == 1
        assert data[0]["data"]["workflow_id"] == "wf-1"

    def test_push_event(self, client: TestClient) -> None:
        """Test pushing a custom event."""
        response = client.post("/api/events/push?event_type=test_event&workflow_id=wf-1")
        assert response.status_code == 200
