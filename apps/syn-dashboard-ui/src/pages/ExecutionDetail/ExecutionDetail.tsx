...
function ExecutionMetricsGrid({ execution }: { execution: ExecutionDetailResponse }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <MetricCard title="Total Tokens" value={totalTokens.toLocaleString()} icon={FileText} subtitle={`In: ${execution.total_input_tokens.toLocaleString()} / Out: ${execution.total_output_tokens.toLocaleString()}`} />
