...
| `--force` | `boolean` | `false` | Reinstall a version that is already installed, overwriting it |
...
| `--force` | `boolean` | `false` | Reinstall even if the resolved version is already installed |
