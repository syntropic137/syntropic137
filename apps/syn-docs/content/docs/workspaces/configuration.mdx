...
Workspace plugins can declare required environment variables in their `plugin.json`. The orchestrator auto-forwards these from workspace configuration. Installable skills and collections live in [agentic-skills](https://github.com/AgentParadise/agentic-skills).
