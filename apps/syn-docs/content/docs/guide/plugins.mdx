...
| `allowed-tools` | Comma-separated list of permitted tools. Inert on claude phases today, and rejected outright on codex phases. See [Choosing an Agent Harness](/docs/guide/workflows#allowed_tools-and-the-two-harnesses) |
