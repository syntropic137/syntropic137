...
from syn_api.types import AgentProviderInfo, AgentTestResult, Err, Ok
...
class TestAgentList:
    def test_list_providers(self) -> None:
        ...
        with patch("syn_api.v1.agents.list_providers", new_callable=AsyncMock) as mock:
...
class TestAgentTest:
    def test_test_success(self) -> None:
        ...
        with patch("syn_api.v1.agents.test_agent", new_callable=AsyncMock) as mock:
