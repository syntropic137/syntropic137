...
from syn_domain.contexts.agent_sessions._shared.value_objects import OperationType, SessionStatus
...
def reset_storage_fixture() -> None:
    ...
    from syn_adapters.projections import reset_projection_manager
...
async def create_test_workflow(workflow_id: str = "test-wf-1") -> WorkflowTemplateAggregate:
    ...
    from syn_adapters.projections import get_projection_manager
