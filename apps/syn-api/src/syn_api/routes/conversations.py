"""Conversation log API endpoints — thin wrapper over v1."""
...
import syn_api.v1.conversations as conv
...
async def get_conversation_metadata(session_id: str) -> ConversationMetadataResponse | None:
