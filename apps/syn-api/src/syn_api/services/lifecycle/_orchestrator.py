"""Lifecycle orchestration — startup, shutdown, and health checks.
...
from ._offline_seed import seed_offline_data
from ._reconciliation import cleanup_orphaned_containers, reconcile_orphaned_sessions
